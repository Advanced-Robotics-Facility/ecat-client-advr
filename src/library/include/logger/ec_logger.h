...
private: 
    ...
    Eigen::VectorXd _x_rate_eigen,_y_rate_eigen,_z_rate_eigen,_x_acc_eigen,_y_acc_eigen,_z_acc_eigen,_x_quat_eigen,_y_quat_eigen,_z_quat_eigen,_w_quat_eigen;
