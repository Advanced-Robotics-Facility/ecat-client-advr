...
int main(int argc, char * const argv[])
{
    ...
    for(int i=0; i< slave_id_vector.size();i++)
    {
        ...
        if(ec_client_cfg.motor_config_map[id].control_mode_type==0xD4){
            ...
            imp_gains_map[id]=ec_client_cfg.motor_config_map[id].gains;
            ...
            throw std::runtime_error("Motor ID: " + std::to_string(id)+ " hasn't an impedance control mode");
        }
    }
