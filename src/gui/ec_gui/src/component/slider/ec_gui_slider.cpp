...
static SliderWidget::slider_info_s gripper_info = {
    GripperPdoTx::name,                                                   
    {"[uless]", "[cm]", "[cm/s]", "[N]", "[N]", "[mm/s]", "[0/1]", "[arbu]", "[arbu]", "[uless]", "[uless]", "[arbu]"}, 
    { 0, 4, 4, 4, 2, 2, 0, 2, 2, 0, 0, 4}, 
    {"0", "0.00", "0.55", "0.00", "75.00", "5.50", "0", "0", "0", "0", "0", "-10000"}, 
    {"500", "8.30", "11.50", "150.00", "150.00", "22.00", "1", "10000", "10000", "2", "65535", "10000"}, 
    { 0, 1, 1, 1, 2, 2, 2, 2, 2, 3, 3, 1}  
};
